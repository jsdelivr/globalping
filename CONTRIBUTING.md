...
- `TIME_SERIES_DB_CONNECTION_HOST`, `TIME_SERIES_DB_CONNECTION_USER`, `TIME_SERIES_DB_CONNECTION_PASSWORD`, and `TIME_SERIES_DB_CONNECTION_DATABASE` time series database connection details
- `REDIS_STANDALONE_PERSISTENT_URL`, `REDIS_STANDALONE_PERSISTENT_NO_EVICTION_URL`, `REDIS_STANDALONE_NON_PERSISTENT_URL`, `REDIS_CLUSTER_MEASUREMENTS_NODES_0`, `REDIS_CLUSTER_MEASUREMENTS_NODES_1`, `REDIS_CLUSTER_MEASUREMENTS_NODES_2`, and
