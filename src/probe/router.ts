...
import { getProbesLocationFilter, type ProbesLocationFilter } from './probes-location-filter.js';
...
export const getProbeRouter = () => {
	if (!router) {
		router = new ProbeRouter(onServerProbesUpdate, getProbesLocationFilter(), getMeasurementStore());
	}
