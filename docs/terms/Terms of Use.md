...
**Globalping** means the Globalping platform further described on the Website, including its APIs, integrations, and hosted Model Context Protocol (MCP) service;

**Measurement Data** means the parameters submitted for a measurement and the results generated by it;
...
Measurement Data is public. Anyone with a measurement ID may access the associated Measurement Data while it remains available. We may also share, publish, index, analyze, or otherwise make Measurement Data discoverable through the Services or third-party services.

You must not include credentials, confidential information, unnecessary personal data, or other content that you do not have the right to make public in measurement targets, options, custom headers, or other inputs. You are responsible for the Measurement Data you submit and acknowledge that it carries no expectation of privacy or confidentiality.

We do not guarantee that Measurement Data will remain available through the Services for any particular period.
...
8. Using Globalping for security testing, including vulnerability scanning, penetration testing, exploit validation, discovery of sensitive resources, or testing to bypass security controls, when you know or reasonably should know that it is likely to trigger abuse complaints or cause third parties to block or restrict traffic from Globalping probes. This restriction applies even if you have permission from the target, because that permission does not extend to Globalping or third-party probe operators. Exceptions require our prior written approval. Ordinary network diagnostics, including connectivity, routing, DNS, TLS and certificate checks, latency, availability, and requests to normal application endpoints, remain permitted.
...
## 13. We may suspend or withdraw our Services
